          ...
          <div className="hero-layout">
            <div className="hero-copy hero-animate">
              ...
              <div className="actions">
               ...
               //<a className="btn btn-outline" href="https://github.com/JanusSacabon" target="_blank" rel="noopener noreferrer">GitHub</a>
              </div>
            </div>
            <div className="hero-photo-wrap hero-photo-animate">
              ...
              <div className="photo-badge photo-badge-ccna">CCNA</div>
              <div className="photo-badge photo-badge-prc">Licensed ECE</div>
            </div>
          </div>
        </section>
